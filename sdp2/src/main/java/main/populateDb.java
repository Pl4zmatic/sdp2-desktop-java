...
public class populateDb {
    public static void main(String[] args) {
        ...
        // machineDaoJpa.insert(new Machine(site, "a-04", "Antwerpen", "Info over het product", "groen",
        //         userDaoJpa.getUserByEmail("technieker@mail.com")));
        // machineDaoJpa.insert(new Machine(site, "a-03", "Antwerpen", "Info over het product", "groen",
        //         userDaoJpa.getUserByEmail("technieker@mail.com")));
        // machineDaoJpa.insert(new Machine(site, "a-02", "Antwerpen", "Info over het product", "groen",
        //         userDaoJpa.getUserByEmail("technieker@mail.com")));
        // machineDaoJpa.insert(new Machine(site, "a-05", "Antwerpen", "Info over het product", "groen",
        //         userDaoJpa.getUserByEmail("technieker@mail.com")));
        // machineDaoJpa.insert(new Machine(site, "a-01", "Antwerpen", "Info over het product", "groen",
        //         userDaoJpa.getUserByEmail("technieker@mail.com")));
